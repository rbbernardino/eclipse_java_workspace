...
public class threadring {
    ...
    public static long tmStt;
    public static long tmStp;
    private static long timeMicroSeg() {
	return (Calendar.getInstance().getTimeInMillis()); //* ((long) (Math.pow(10, -3)));
    }
    ...
    private class Node implements Runnable {
        ...
        public void run() {
			...
			//                        System.out.println("ending node "+nodeId);
			    ...
			    tmStp = timeMicroSeg();
			    System.out.println("Tempo: " + (tmStp - tmStt));
